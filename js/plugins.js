...
`OWL Carousel                   --> Mobile-friendly slider
`Smart Search                   --> Search form
`jQuery Easing                  --> Uses the built in easing capabilities added In jQuery 1.1 (v1.3)
`jQuery Ketchup Plugin          --> Tasty Form Validation (v0.3.1)
`jQuery Validation Plugin       --> Form Validation Plugin (v1.13.1) 
`jQuery Form Plugin             --> jQuery Form Plugin (v3.51.0)
`Sticky Plugin                  --> Sticky header (v1.0.0)
`ScrollIt                       --> Makes it easy to make long, vertically scrolling pages.
`Bootstrap                      --> Twitter Bootstrap (v3.3.2)
`Bootstrap Transition           --> Bootstrap Transition (v2.3.2)
`jQuery mb YTPlayer             --> YouTube jQuery plugin
`jQuery Swipebox                --> Photo Gallery (v1.3.0.2)
`modernizr.custom.79639         --> Modernizr (v2.5.3)
`scrollReveal                   --> scrollReveal
`jquery.parallax                --> jquery.parallax (v1.1.3)
`modernizr-isotope              --> Modernizr isotope (v2.7.1)
`isotope.pkgd                   --> Isotope PACKAGED - Filter & sort magical layouts - (v2.0.1)
`imagesloaded.pkgd              --> imagesLoaded PACKAGED (v3.1.8)
`superplaceholder.js            --> superplaceholder.js
`animate.js                     --> animate.js
`moment.js                      --> moment.js v2.9.0
...
// (function() {
//     var amaezisearch = document.getElementById( 'amaezisearch' ),
//         input = amaezisearch.querySelector( '.search-input' ),
//         ctrlClose = amaezisearch.querySelector( 'span.amaezisearch-close' ),
...
//             var offsets = amaezisearch.getBoundingClientRect();
//             if( isOpen ) {
//                 classie.remove( amaezisearch, 'open' );

//                 // trick to hide input text once the search overlay closes 
//                 // todo: hardcoded times, should be done after transition ends
//                 if( input.value !== '' ) {
//                     setTimeout(function() {
//                         classie.add( amaezisearch, 'hideInput' );
//                         setTimeout(function() {
//                             classie.remove( amaezisearch, 'hideInput' );
//                             input.value = '';
//                         }, 300 );
//                     }, 500);
//                 }
